...
if (!Array.prototype.groupBy) {
  Array.prototype.groupBy = function(prop: string , fields?: string | Function | any): any[] {
    let key;
...
if (!Array.prototype.unique) {
  Array.prototype.unique = function(field) { // tslint:disable-line: typedef
    ...
    Object.keys(o).forEach(i => { r.push(o[i]); });
    return r;
  };
}
...
if (!Array.prototype.take) {
  Array.prototype.take = function(numberOf) { // tslint:disable-line: typedef
    let begin;
    let end;
    if (numberOf >= 0) {
      begin = 0;
